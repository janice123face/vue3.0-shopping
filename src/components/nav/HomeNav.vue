  ...
  <div>
    <div class="nav-item">
      ...
      <div class="nav-side" ref="navSide">
        <ul>
          <li class="demo-tabs" @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
      ...
      <div class="nav-content">
        <!-- 幻灯片 -->
        <div>
          <el-carousel :interval="5000" arrow="always" height="340px"  style="border:1px solid red;">
              <el-carousel-item  v-for="(item, index) in marketing.CarouselItems" :key="index">
      ...
      <div class="detail-item-panel panel-1" :duration="{ enter: 100, leave: 100 }" v-show="panel1" @mouseenter="showDetail(1)" ref="itemPanel1" @mouseleave="hideDetail(1)">
        ...
        <ul>
          <li v-for="(items, index) in panelData1.classNav" :key="index" class="detail-item-row">
            ...
            <router-link to="/GoodList" v-for="(item, subIndex) in items.tags" :key="subIndex">
