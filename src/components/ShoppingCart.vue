<template>
  <div>
        ...
        <div class="car-btn-group">
          ...
          <div class="car-btn-row">
            <router-link to="/goodsDetail">
              <ElButton class="btn-car btn-car-to-detail">查看商品详情</ElButton>
            </router-link>
            <router-link to="/order">
              <ElButton class="btn-car btn-car-to-pay">去购物车结算 > </ElButton>
            </router-link>
          </div>
        </div>
      </div>
    ...
    <div class="other-user-buy-box">
      ...
      <div class="other-user-buy-row" v-for="(items,index1) in $store.state.recommend" :key="index1">
        <div class="other-user-buy-item-box" v-for="(item,index2) in items" :key="index2">
          ...
          <div class="other-buy-detail-box">
            ...
            <div class="other-buy-btn-box">
              <router-link to="/goodsDetail">
                <ElButton class="other-buy-btn"><Icon type="ios-cart"></Icon> 加入购物车</ElButton>
              </router-link>
            </div>
          </div>
        </div>
