    ...
    <div class="content">
      ...
      <div class="seckill">
        ...
        <div class="seckill-content">
          <div class="seckill-item" v-for="(item, index) in $store.state. seckills.goodsList" :key="index">
            <div class="seckill-item-img">
              <router-link to="/GoodList"><img :src="item.img"></router-link>
            </div>
      ...
      <div class="item-class">
        <div class="item-class-head">
          <span class="item-class-title">{{$store.state.computer.title}}</span>
          <ul>
            <li v-for="(item, index) in $store.state.computer.link" :key="index">
              <router-link to="/GoodList">{{item}}</router-link>
            </li>
          </ul>
        </div>
        <div class="item-class-content" v-for="(item, index) in $store.state.computer.detail" :key="index">
      ...
      <div class="item-class">
        <div class="item-class-head item-class-eat-head">
          <span class="item-class-title">{{$store.state.eat.title}}</span>
          <ul>
            <li v-for="(item, index) in $store.state.eat.link" :key="index">
              <router-link to="/GoodList">{{item}}</router-link>
            </li>
          </ul>
        </div>
        <div class="item-class-content" v-for="(item, index) in $store.state.eat.detail" :key="index">
          <div class="item-content-top">
            <div class="item-big-img">
              <img :src="item.bigImg" alt="">
            </div>
